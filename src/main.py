...
metric_params = {"batch_size": batch_size,
...
test_acc_all,train_acc_all = train(model, optimizer, scheduler, train_loader=train_loader, test_loader=test_loader, device=device, num_epochs=num_epochs, metric_params)
